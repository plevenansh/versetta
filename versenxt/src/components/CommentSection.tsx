...
export const CommentSection: React.FC<CommentSectionProps> = ({ projectId, mainStageId, subStageId, contextName }) => {
  ...
  const { data: mentionableUsers } = trpc.comments.getMentionableUsers.useQuery(projectId);
