...
export function FileList({ 
  ...
  const [fileType, setFileType] = useState<StorageType | 'all'>('all');
  ...
  return (
    <div className={className}>
      <div className="mb-4 flex items-center justify-between gap-4">
        ...
        <Select 
          value={fileType} 
          onValueChange={(value: StorageType | 'all') => setFileType(value)}
        >
          ...
          <SelectContent>
            ...
            <SelectItem value={StorageType.THUMBNAIL}>Thumbnails</SelectItem>
            <SelectItem value={StorageType.STOCK_FOOTAGE}>Raw Footage</SelectItem>
            <SelectItem value={StorageType.FINISHED_VIDEO}>Finished Videos</SelectItem>
            <SelectItem value={StorageType.PROJECT_ASSET}>Project Assets</SelectItem>
            <SelectItem value={StorageType.TEAM_ASSET}>Team Assets</SelectItem>
            <SelectItem value={StorageType.OTHER}>Other</SelectItem>
          </SelectContent>
        </Select>
        <div className="flex items-center space-x-2">
          <Button
