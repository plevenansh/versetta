        ...
        <CardContent>
          <div className="space-y-4">
            <div>
              ...
              <Input id="title" placeholder="Enter video title" defaultValue="How to Make the Perfect Cup of Coffee: A Step-by-Step Guide" />
            </div>
            <div>
              <label htmlFor="description" className="block text-sm font-medium text-muted-foreground mb-1">Description</label>
              <Textarea id="description" placeholder="Enter video description" className="min-h-[100px]" defaultValue="Learn the secrets to brewing the perfect cup of coffee at home. In this video, we'll guide you through choosing the right beans, grinding techniques, and brewing methods to elevate your coffee game." />
            </div>
            <div>
              <label htmlFor="tags" className="block text-sm font-medium text-muted-foreground mb-1">Tags</label>
              <Input id="tags" placeholder="Enter tags separated by commas" defaultValue="coffee, brewing, barista, home brewing, coffee tips" />
            </div>
            <div>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              <Input type="datetime-local" defaultValue="2023-07-15T09:00" />
              <Button>Schedule</Button>
            </div>
            <div className="flex items-center space-x-2">
              <Switch id="notify-subscribers" />
